...
import com.econocom.mp.domain.JobHistory;
import com.econocom.mp.repository.JobHistoryRepository;
import com.econocom.mp.repository.search.JobHistorySearchRepository;
import com.econocom.mp.service.JobHistoryService;
...
import static com.econocom.mp.web.rest.TestUtil.createFormattingConversionService;
...
import com.econocom.mp.domain.enumeration.Language;
/**
...
public class JobHistoryResourceIntTest {
     ...
     *
     * @see com.econocom.mp.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
